...
(function () {
  ...
  if (
    document.getElementById('swupMain') ||
    document.getElementById('swupMenu')
  ) {
  ...
  /***************************
    ...
    ***************************/
  var swiper = new Swiper('.impkt-works-slider', {
    slidesPerView: 1,
    spaceBetween: 0,
    speed: 800,
    parallax: true,
    ...
    navigation: {
      nextEl: '.impkt-works-next',
      prevEl: '.impkt-works-prev',
    },
    pagination: {
